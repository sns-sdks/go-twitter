...
func TestString(t *testing.T) {
	var tests = []struct {
		...
		{BookmarkedStatus{Bookmarked: Bool(true)}, `twitter.BookmarkedStatus{Bookmarked:true}`},
		...
		{BookmarkedResp{Data: &BookmarkedStatus{Bookmarked: Bool(false)}}, `twitter.BookmarkedResp{Data:twitter.BookmarkedStatus{Bookmarked:false}}`},
